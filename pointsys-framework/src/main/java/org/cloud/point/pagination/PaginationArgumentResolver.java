...
public class PaginationArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public boolean supportsParameter(MethodParameter parameter) {
        ...
        return clazz.isAssignableFrom(PaginationRequest.class);
    }
    ...
    private void removeParam(PaginationRequest tableRequest) {
    ...
    private void setOrderBy(PaginationRequest tableRequest, Map<String, Object> map) {
